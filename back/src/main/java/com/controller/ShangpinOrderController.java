    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(shangpinOrder !=null){
            ...
            BeanUtils.copyProperties( shangpinOrder , view );//把实体数据重构到view中
                ...
                //级联表
                CaigouyuanEntity caigouyuan = caigouyuanService.selectById(shangpinOrder.getCaigouyuanId());
                if(caigouyuan != null){
                    BeanUtils.copyProperties( caigouyuan , view ,new String[]{ "id", "createTime", "insertTime", "updateTime"});//把级联的数据添加到view中,并排除id和创建时间字段
                    view.setCaigouyuanId(caigouyuan.getId());
                }
                //级联表
    ...
    */
    ...
    public R save(@RequestBody ShangpinOrderEntity shangpinOrder, HttpServletRequest request){
        ...
        if(false)
            ...
            shangpinOrder.setCaigouyuanId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        else if("用户".equals(role))
...
//                            shangpinOrderEntity.setCaigouyuanId(Integer.valueOf(data.get(0)));   //采购员 要改的
...
//                            shangpinOrderEntity.setCreateTime(date);//时间
        ...
        ShangpinOrderEntity shangpinOrder = shangpinOrderService.selectById(id);
            if(shangpinOrder !=null){
                ...
                //级联表
                    CaigouyuanEntity caigouyuan = caigouyuanService.selectById(shangpinOrder.getCaigouyuanId());
                if(caigouyuan != null){
                    BeanUtils.copyProperties( caigouyuan , view ,new String[]{ "id", "createDate"});//把级联的数据添加到view中,并排除id和创建时间字段
                    view.setCaigouyuanId(caigouyuan.getId());
                }
                //级联表
                    ShangpinEntity shangpin = shangpinService.selectById(shangpinOrder.getShangpinId());
    ...
    */
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        Integer caigouyuanId = Integer.valueOf(String.valueOf(params.get("caigouyuanId")));//采购员
