<template>
    <div style="backgroundImage: url('/xiaoqutuangou/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">小区团购管理注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="采购员姓名" class="input" v-if="tableName=='caigouyuan'">
                            <el-input v-model="ruleForm.caigouyuanName" autocomplete="off" placeholder="采购员姓名"  />
                        </el-form-item>
                        <el-form-item label="采购员手机号" class="input" v-if="tableName=='caigouyuan'">
                            <el-input v-model="ruleForm.caigouyuanPhone" autocomplete="off" placeholder="采购员手机号"  />
                        </el-form-item>
                        <el-form-item label="采购员身份证号" class="input" v-if="tableName=='caigouyuan'">
                            <el-input v-model="ruleForm.caigouyuanIdNumber" autocomplete="off" placeholder="采购员身份证号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='caigouyuan'">
                            <el-input v-model="ruleForm.caigouyuanEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.caigouyuanName)&& 'caigouyuan'==this.tableName){
                                this.$message.error('采购员姓名不能为空');
                                return
                            }
                             if('caigouyuan' == this.tableName && this.ruleForm.caigouyuanPhone&&(!this.$validate.isMobile(this.ruleForm.caigouyuanPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.caigouyuanIdNumber)&& 'caigouyuan'==this.tableName){
                                this.$message.error('采购员身份证号不能为空');
                                return
                            }
                            if('caigouyuan' == this.tableName && this.ruleForm.caigouyuanEmail&&(!this.$validate.isEmail(this.ruleForm.caigouyuanEmail))){
