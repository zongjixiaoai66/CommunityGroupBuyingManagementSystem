<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='caigouyuan'"  label='采购员姓名' prop="caigouyuanName">
               <el-input v-model="ruleForm.caigouyuanName"  placeholder='采购员姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='caigouyuan'"  label='采购员手机号' prop="caigouyuanPhone">
               <el-input v-model="ruleForm.caigouyuanPhone"  placeholder='采购员手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='caigouyuan'"  label='采购员身份证号' prop="caigouyuanIdNumber">
               <el-input v-model="ruleForm.caigouyuanIdNumber"  placeholder='采购员身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='caigouyuan'" label='采购员头像' prop="caigouyuanPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='caigouyuan'"  label='电子邮箱' prop="caigouyuanEmail">
               <el-input v-model="ruleForm.caigouyuanEmail"  placeholder='电子邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
...
// 注册表 采购员 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.caigouyuanName)&& 'caigouyuan'==this.flag){
                             this.$message.error('采购员姓名不能为空');
                             return
                         }

                             if( 'caigouyuan' ==this.flag && this.ruleForm.caigouyuanPhone&&(!isMobile(this.ruleForm.caigouyuanPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.caigouyuanIdNumber)&& 'caigouyuan'==this.flag){
                             this.$message.error('采购员身份证号不能为空');
                             return
                         }

                         if((!this.ruleForm.caigouyuanPhoto)&& 'caigouyuan'==this.flag){
                             this.$message.error('采购员头像不能为空');
                             return
                         }

                             if( 'caigouyuan' ==this.flag && this.ruleForm.caigouyuanEmail&&(!isEmail(this.ruleForm.caigouyuanEmail))){
