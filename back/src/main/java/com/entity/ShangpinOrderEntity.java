...
public class ShangpinOrderEntity<T> implements Serializable {
     ...
     * 采购员
     */
    @TableField(value = "caigouyuan_id")

    private Integer caigouyuanId;
	 ...
	 * 设置：采购员
	 */
    public Integer getCaigouyuanId() {
        return caigouyuanId;
    }
    /**
	 * 获取：采购员
    ...
    public void setCaigouyuanId(Integer caigouyuanId) {
        this.caigouyuanId = caigouyuanId;
    }
    /**
	 * 设置：用户
	 */
