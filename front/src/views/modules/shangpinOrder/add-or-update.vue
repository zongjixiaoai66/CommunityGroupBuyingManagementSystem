    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='caigouyuan'">
                    <el-form-item class="select" v-if="type!='info'"  label="采购员" prop="caigouyuanId">
                        <el-select v-model="ruleForm.caigouyuanId" :disabled="ro.caigouyuanId" filterable placeholder="请选择采购员" @change="caigouyuanChange">
                            <el-option
                                    v-for="(item,index) in caigouyuanOptions"
                                    v-bind:key="item.id"
                                    :label="item.caigouyuanName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='caigouyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="采购员姓名" prop="caigouyuanName">
                        <el-input v-model="caigouyuanForm.caigouyuanName"
            ...
            <input id="caigouyuanId" name="caigouyuanId" type="hidden">
...
<script>
    ...
    export default {
        ...
        created() {
         ...
         this.$http({
             url: `caigouyuan/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.caigouyuanOptions = data.data.list;
            }
         });
         this.$http({
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.caigouyuanChange(data.data.caigouyuanId)
